...
- Made a Few Changes For North Korea, Mainly Laws, and Some Description Changes.
...
- All Dilemmas Should Work Now. ( Hopefully )

Update 0.8.1 Dec 8th, 2020:
...
- Added One Event, Three Dilemmas, and one situation, The three dilemmas are Russia only and the rest of the staff are all nations.
- Changed Pop Number For Russia, I was using the real-life number.

Update 0.5 Dec 6th, 2020:
- Made a Few Optimizations.

Update 0.4 Dec 6th, 2020:
- Made Some UI Changes, Mainly Made a Few Images Darker, Sorry Light Mode Users ( Just Delete D4 Overhaul & Expansion\data\bitmaps\ui Images ) (Bugged)
Seems that I can't edit images for the steam version.

Update 0.3 Dec 6th, 2020:
- Updated Policies For Russia.
- Added Russian Names.
